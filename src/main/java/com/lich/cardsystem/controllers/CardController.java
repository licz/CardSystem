...
public class CardController {
    ...
    @RequestMapping(value="/card/{cardId}/authorize/{amount}", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value="/card/{cardId}/capture/{transactionId}", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value="/card/{cardId}/reverse/{transactionId}/{amount}", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value="/card/{cardId}/refund/{transactionId}/{amount}", method = RequestMethod.POST)
    public @ResponseBody
    ...
    public @ResponseBody
    Card getCard(@PathVariable("cardId") String cardId) throws CardException {
        return cardProcessor.getCard(cardId);
    }
}
